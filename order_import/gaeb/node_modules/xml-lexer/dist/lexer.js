...
var create = function create(options) {
  var _State$data,
    ...
    _State$tagName,
    _State$tagEnd,
    _State$attributeNameS,
    _State$attributeName,
    _State$attributeNameE,
    _State$attributeValue,
    _State$attributeValue2,
    _lexer$stateMachine;
  ...
  lexer.stateMachine =
    ...
    _defineProperty(
      ...
      State.data,
      ((_State$data = {}),
      _defineProperty(_State$data, Action.lt, function() {
        if (data.trim()) {
          emit(Type.text, data);
        }
        tagName = "";
    ...
    _defineProperty(
      _lexer$stateMachine,
      State.cdata,
      _defineProperty({}, Action.char, function(char) {
        data += char;
        if (data.substr(-3) === "]]>") {
    ...
    _defineProperty(
      ...
      State.tagBegin,
      ((_State$tagBegin = {}),
      _defineProperty(_State$tagBegin, Action.space, noop),
      _defineProperty(_State$tagBegin, Action.char, function(char) {
        tagName = char;
        state = State.tagName;
      }),
    ...
    _defineProperty(
      ...
      State.tagName,
      ((_State$tagName = {}),
      _defineProperty(_State$tagName, Action.space, function() {
        if (isClosing) {
          state = State.tagEnd;
        } else {
    ...
    _defineProperty(
      ...
      State.tagEnd,
      ((_State$tagEnd = {}),
      _defineProperty(_State$tagEnd, Action.gt, function() {
        emit(Type.closeTag, tagName);
        data = "";
        state = State.data;
      }),
      _defineProperty(_State$tagEnd, Action.char, noop),
      _State$tagEnd)
    ),
    _defineProperty(
      _lexer$stateMachine,
      ...
      ((_State$attributeNameS = {}),
      _defineProperty(_State$attributeNameS, Action.char, function(char) {
        attrName = char;
      ...
      _defineProperty(_State$attributeNameS, Action.space, noop),
      _defineProperty(_State$attributeNameS, Action.slash, function() {
        isClosing = true;
        state = State.tagEnd;
      }),
      _State$attributeNameS)
    ...
    _defineProperty(
      ...
      State.attributeName,
      ((_State$attributeName = {}),
      _defineProperty(_State$attributeName, Action.space, function() {
    ...
    _defineProperty(
      ...
      ((_State$attributeNameE = {}),
      _defineProperty(_State$attributeNameE, Action.space, noop),
      _defineProperty(_State$attributeNameE, Action.equal, function() {
        emit(Type.attributeName, attrName);
        state = State.attributeValueBegin;
      }),
    ...
    _defineProperty(
      ...
      ((_State$attributeValue = {}),
      _defineProperty(_State$attributeValue, Action.space, noop),
      _defineProperty(_State$attributeValue, Action.quote, function(char) {
        openingQuote = char;
        attrValue = "";
    ...
    _defineProperty(
      ...
      ((_State$attributeValue2 = {}),
      _defineProperty(_State$attributeValue2, Action.space, function(char) {
        if (openingQuote) {
          attrValue += char;
        } else {
          emit(Type.attributeValue, attrValue);
  ...
  var step = function step(char) {
    ...
    var action =
      actions[getAction(char)] || actions[Action.error] || actions[Action.char];
    action(char);
  };
